...
export const issue = z.object({
	...
	// The `remove` action drops the top-level url field.
	...
	data: z.object({
		...
		// Linear has been pruning structural fields from the Issue payload
		// over time (boardOrder was removed in 2024). Keep these all
		// optional so a future drop doesn't take the worker down.
